...
### 활성 문서
- [`plan-v3-complete-codex-replacement.md`](./plan-v3-complete-codex-replacement.md) — **활성 계획** (Perplexity 완전 제거)
- [`perplexity-usage-analysis.md`](./perplexity-usage-analysis.md) — Perplexity 활용 방식 전수 조사
- [`comparison-samsungsdi-2026-04-23.md`](./comparison-samsungsdi-2026-04-23.md) — 3-way 품질 비교 실측
- [`codex-cli-reference.md`](./codex-cli-reference.md) — Codex CLI 호출 스펙·프롬프트·에러 매트릭스
